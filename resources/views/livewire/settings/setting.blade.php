                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <ul class="list-inline mb-4">
                                            ...
                                            <li class="list-inline-item d-block border-bottom me-0">
                                                <a href="{{route('settings.savedpost')}}" class="pt-2 pb-2 d-flex align-items-center">
                                            ...
                                            <li class="list-inline-item d-block me-0">
                                                <a href="{{route('settings.socials')}}" class="pt-2 pb-2 d-flex align-items-center">
                                        ...
                                        <ul class="list-inline">
                                            <li class="list-inline-item d-block border-bottom me-0">
                                                <a href="{{route('settings.notifications')}}" class="pt-2 pb-2 d-flex align-items-center">
                                            ...
                                            <li class="list-inline-item d-block border-bottom me-0">
                                                <a href="{{route('help')}}" class="pt-2 pb-2 d-flex align-items-center">

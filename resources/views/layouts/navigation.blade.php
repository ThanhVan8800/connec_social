...
<div class="nav-header bg-white shadow-xs border-0">
    ...
    ?>
            <div class="nav-top">
                ...
                <span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">{{config("app.name")}} </span> </a>
            ...
            <form action="#" class="float-left header-search">
                <div class="form-group mb-0 icon-input">
                    <i class=" font-sm text-grey-400"></i>
            ...
            <a href=" " class="p-2 text-center ms-0 menu-icon center-menu-icon">

                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="name" type="text" placeholder="username"
                                            value="" class="form-control">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-end p-0">
                                            <div class="form-group mb-0 w-100">
                                                <input wire:model.lazy="profile" type="file" name="profile"
                                                    id="file" class="input-file" value="{{asset('storage').'/'.$user->profile}}">
                                                <label for="file"
                                                    ...
                                                    <span class="js-fileName">Drag and drop or click to update profile image
                                                        </span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-end p-0">
                                            <div class="form-group mb-0 w-100">
                                                <input wire:model.lazy="thumbnail" type="file" name="thumbnail"
                                                    id="thumbnail" class="input-file" value="{{asset('storage').'/'.$user->thumbnail}}">
                                                <label for="thumbnail"
                                                    class="rounded-3 text-center bg-white btn-tertiary js-labelFile p-4 w-100 border-dashed">
                                                    <i class=" large-icon me-3 d-block"
                                                        style="margin-top: -10px">{!! $icons->getIcon('cloud') !!}</i>

                ...
                <div class="col-12">
                    ...
                    @foreach ($post->commentss as $comment)
                        <div class="p-4 mt-3 mb-1  text-center border-0 border-bottom card w-100 shadow-xss rounded-xxl">
                            ...
                            alt="image" class="shadow-sm rounded-circle w45"></figure>
                                <h4 class="mt-1 fw-700 text-grey-900 font-xssss">{{ $comment->user->name }} </h4>
                            </div>
                            <div style="display:flex;justify-content: space-between;">
                                ...
                                <span class="mt-1 font-xssss fw-500 lh-3 text-grey-500">{{ $comment->created_at->diffForHumans() }}</span>
                            </div>
                        </div>
                    @endforeach
